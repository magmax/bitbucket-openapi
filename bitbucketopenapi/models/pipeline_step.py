...
class PipelineStep(object):
    ...
    def __init__(self, completed_on=None, image=None, script_commands=None, setup_commands=None, started_on=None, state=None, uuid=None):  # noqa: E501
        """PipelineStep - a model defined in OpenAPI"""  # noqa: E501
    ...
    def completed_on(self, completed_on):
        """Sets the completed_on of this PipelineStep.

        The timestamp when the step execution was completed. This is not set if the step is still in progress.  # noqa: E501

        :param completed_on: The completed_on of this PipelineStep.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def image(self):
        """Gets the image of this PipelineStep.  # noqa: E501


        :return: The image of this PipelineStep.  # noqa: E501
        :rtype: PipelineImage
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this PipelineStep.


        :param image: The image of this PipelineStep.  # noqa: E501
        :type: PipelineImage
        """
    ...
    def script_commands(self):
        """Gets the script_commands of this PipelineStep.  # noqa: E501

        The list of build commands. These commands are executed in the build container.  # noqa: E501

        :return: The script_commands of this PipelineStep.  # noqa: E501
    ...
    def script_commands(self, script_commands):
        """Sets the script_commands of this PipelineStep.

        The list of build commands. These commands are executed in the build container.  # noqa: E501

        :param script_commands: The script_commands of this PipelineStep.  # noqa: E501
    ...
    def setup_commands(self):
        """Gets the setup_commands of this PipelineStep.  # noqa: E501
        ...
        :return: The setup_commands of this PipelineStep.  # noqa: E501
        :rtype: list[PipelineCommand]
        """
    ...
    def setup_commands(self, setup_commands):
        """Sets the setup_commands of this PipelineStep.

        The list of commands that are executed as part of the setup phase of the build. These commands are executed outside the build container.  # noqa: E501

        :param setup_commands: The setup_commands of this PipelineStep.  # noqa: E501
        :type: list[PipelineCommand]
        """
    ...
    def started_on(self, started_on):
        """Sets the started_on of this PipelineStep.

        The timestamp when the step execution was started. This is not set when the step hasn't executed yet.  # noqa: E501

        :param started_on: The started_on of this PipelineStep.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def state(self):
        """Gets the state of this PipelineStep.  # noqa: E501


        :return: The state of this PipelineStep.  # noqa: E501
    ...
    def state(self, state):
        """Sets the state of this PipelineStep.


        :param state: The state of this PipelineStep.  # noqa: E501
    ...
    @property
    def uuid(self):
        """Gets the uuid of this PipelineStep.  # noqa: E501

        The UUID identifying the step.  # noqa: E501

        :return: The uuid of this PipelineStep.  # noqa: E501
        :rtype: str
        """
        return self._uuid
    ...
    @uuid.setter
    def uuid(self, uuid):
        """Sets the uuid of this PipelineStep.

        The UUID identifying the step.  # noqa: E501

        :param uuid: The uuid of this PipelineStep.  # noqa: E501
        :type: str
        """
