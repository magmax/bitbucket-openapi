...
class PaginatedSnippets(object):
    ...
    def __init__(self, next=None, page=None, pagelen=None, previous=None, size=None, values=None):  # noqa: E501
        """PaginatedSnippets - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def next(self):
        """Gets the next of this PaginatedSnippets.  # noqa: E501
        ...
        :return: The next of this PaginatedSnippets.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this PaginatedSnippets.

        Link to the next page if it exists. The last page of a collection does not have this value. Use this link to navigate the result set and refrain from constructing your own URLs.  # noqa: E501

        :param next: The next of this PaginatedSnippets.  # noqa: E501
        :type: str
        """
    ...
    @page.setter
    def page(self, page):
        """Sets the page of this PaginatedSnippets.

        Page number of the current results. This is an optional element that is not provided in all responses.  # noqa: E501

        :param page: The page of this PaginatedSnippets.  # noqa: E501
        :type: int
        """
    ...
    @property
    def pagelen(self):
        """Gets the pagelen of this PaginatedSnippets.  # noqa: E501
        ...
        :return: The pagelen of this PaginatedSnippets.  # noqa: E501
        :rtype: int
        """
    ...
    def pagelen(self, pagelen):
        """Sets the pagelen of this PaginatedSnippets.

        Current number of objects on the existing page. The default value is 10 with 100 being the maximum allowed value. Individual APIs may enforce different values.  # noqa: E501

        :param pagelen: The pagelen of this PaginatedSnippets.  # noqa: E501
        :type: int
        """
    ...
    @property
    def previous(self):
        """Gets the previous of this PaginatedSnippets.  # noqa: E501
        ...
        :return: The previous of this PaginatedSnippets.  # noqa: E501
        :rtype: str
        """
    ...
    def previous(self, previous):
        """Sets the previous of this PaginatedSnippets.

        Link to previous page if it exists. A collections first page does not have this value. This is an optional element that is not provided in all responses. Some result sets strictly support forward navigation and never provide previous links. Clients must anticipate that backwards navigation is not always available. Use this link to navigate the result set and refrain from constructing your own URLs.  # noqa: E501

        :param previous: The previous of this PaginatedSnippets.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this PaginatedSnippets.  # noqa: E501
        ...
        :return: The size of this PaginatedSnippets.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this PaginatedSnippets.

        Total number of objects in the response. This is an optional element that is not provided in all responses, as it can be expensive to compute.  # noqa: E501

        :param size: The size of this PaginatedSnippets.  # noqa: E501
        :type: int
        """
    ...
    @property
    def values(self):
        """Gets the values of this PaginatedSnippets.  # noqa: E501


        :return: The values of this PaginatedSnippets.  # noqa: E501
        :rtype: list[Snippet]
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this PaginatedSnippets.


        :param values: The values of this PaginatedSnippets.  # noqa: E501
        :type: list[Snippet]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaginatedSnippets):
            return False
